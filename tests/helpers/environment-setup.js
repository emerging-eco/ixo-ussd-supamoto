...
export class EnvironmentSetup {
     ...
     */
    getDefaultConfig() {
        const environment = process.env.TEST_ENVIRONMENT || "mocked";
        return {
            environment,
            useRealDatabase: environment === "real" && process.env.USE_REAL_DATABASE === "true",
            useRealIxoServices: environment === "real" && process.env.USE_REAL_IXO_SERVICES === "true",
            useRealMatrix: environment === "real" && process.env.USE_REAL_MATRIX === "true",
