...
const defaultValues = {
    ...
    MATRIX_HOME_SERVER: process.env.MATRIX_HOME_SERVER || "https://devmx.ixo.earth",
...
console.log(`🔗 Server URL: ${process.env.USSD_TEST_SERVER_URL || "http://127.0.0.1:3005/api/ussd"}`);
console.log("");
console.log("⚠️  Make sure the USSD server is running before executing flow tests!");
