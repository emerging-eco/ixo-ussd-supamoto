 ...
 * - Session ID: rec-03-login-wrong-pin-1774612357710-9
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T11:52:43.043Z
 * - Turns: 9
 *
...
describe("03-login-wrong-pin - USSD Flow Test", () => {
  ...
  it("Turn 5: Input: \"99999\"", async () => {
    ...
    // Cumulative USSD text: "2*1*CBDAAD707*99999"
    // Send user input (USSD requires cumulative text)
  ...
  it("Turn 6: Input: \"12345\"", async () => {
    ...
    // Cumulative USSD text: "2*1*CBDAAD707*99999*12345"
    // Send user input (USSD requires cumulative text)
  ...
  it("Turn 7: Input: \"1\"", async () => {
    ...
    // Cumulative USSD text: "2*1*CBDAAD707*99999*12345*1"
    // Send user input (USSD requires cumulative text)
  ...
  it("Turn 8: Input: \"1\"", async () => {
    ...
    // Cumulative USSD text: "2*1*CBDAAD707*99999*12345*1*1"
    // Send user input (USSD requires cumulative text)
  ...
  it("Turn 9: Input: \"0\"", async () => {
    ...
    // Cumulative USSD text: "2*1*CBDAAD707*99999*12345*1*1*0"
    // Send user input (USSD requires cumulative text)
