/**
 * Generated Test: 04-customer-tools-menu
 *
 * This test was automatically generated from a recorded USSD session.
 *
 * Session Details:
 * - Flow: 04-customer-tools-menu
 * - Session ID: rec-04-customer-tools-menu-1774608354261-11
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T10:45:58.991Z
 * - Turns: 8
 *
 ...
 *    pnpm test tests/flows/04-customer-tools-menu.test.ts  # Won't work
 *
 * Prerequisites:
 ...
 * 3. Run: pnpm generate:test <log-file> 04-customer-tools-menu
 *
 * @generated
 */
...
const SESSION_ID = `flow-test-04-customer-tools-menu-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`;
...
describe("04-customer-tools-menu - USSD Flow Test", () => {
