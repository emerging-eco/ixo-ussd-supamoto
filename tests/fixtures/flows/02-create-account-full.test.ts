 ...
 * - Session ID: rec-02-create-account-full-1774612322058-3
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T11:52:07.998Z
 * - Turns: 10
 *
 ...
 *    pnpm test tests/flows/02-create-account-full.test.ts  # Won't work
 *
 * Prerequisites:
 ...
 * 3. Run: pnpm generate:test <log-file> 02-create-account-full
 *
 * @generated
 */
...
describe("02-create-account-full - USSD Flow Test", () => {
  ...
  it("Turn 6: Input: \"123456/12/1\"", async () => {
    // Simulate realistic user interaction timing (2-second delay)
    await new Promise(resolve => setTimeout(resolve, 2000));

    // Cumulative USSD text: "2*2*John Doe*john@test.com*123456/12/1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*John Doe*john@test.com*123456/12/1");
  ...
  it("Turn 7: Input: \"12345\"", async () => {
    ...
    // Cumulative USSD text: "2*2*John Doe*john@test.com*123456/12/1*12345"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*John Doe*john@test.com*123456/12/1*12345");
  ...
  it("Turn 8: Input: \"12345\"", async () => {
    ...
    // Cumulative USSD text: "2*2*John Doe*john@test.com*123456/12/1*12345*12345"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*John Doe*john@test.com*123456/12/1*12345*12345");
  ...
  it("Turn 9: Input: \"1\"", async () => {
    ...
    // Cumulative USSD text: "2*2*John Doe*john@test.com*123456/12/1*12345*12345*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*John Doe*john@test.com*123456/12/1*12345*12345*1");
  ...
  it("Turn 10: Input: \"1\"", async () => {
    ...
    // Cumulative USSD text: "2*2*John Doe*john@test.com*123456/12/1*12345*12345*1*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*John Doe*john@test.com*123456/12/1*12345*12345*1*1");
