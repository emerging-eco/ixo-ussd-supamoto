/**
 * Generated Test: 06-exit-from-any-menu
 *
 ...
 *    pnpm test tests/flows/06-exit-from-any-menu.test.ts  # Won't work
 *
 * Prerequisites:
 ...
 * 3. Run: pnpm generate:test <log-file> 06-exit-from-any-menu
 *
 * @generated
 */
...
const SESSION_ID = `flow-test-06-exit-from-any-menu-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`;
...
describe("06-exit-from-any-menu - USSD Flow Test", () => {
