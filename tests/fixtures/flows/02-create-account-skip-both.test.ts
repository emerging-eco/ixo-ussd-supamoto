 ...
 * - Session ID: rec-02-create-account-skip-both-1774612339870-6
 * - Phone: +260971230001
 * - Service Code: *2233#
 * - Recorded: 2026-03-27T11:52:25.803Z
 * - Turns: 10
 *
 ...
 *    pnpm test tests/flows/02-create-account-skip-both.test.ts  # Won't work
 *
 * Prerequisites:
 ...
 * 3. Run: pnpm generate:test <log-file> 02-create-account-skip-both
 *
 * @generated
 */
...
describe("02-create-account-skip-both - USSD Flow Test", () => {
  ...
  it("Turn 6: Input: \"00\"", async () => {
    ...
    // Cumulative USSD text: "2*2*Alice Brown*00*00"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Alice Brown*00*00");
  ...
  it("Turn 7: Input: \"12345\"", async () => {
    ...
    // Cumulative USSD text: "2*2*Alice Brown*00*00*12345"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Alice Brown*00*00*12345");
  ...
  it("Turn 8: Input: \"12345\"", async () => {
    ...
    // Cumulative USSD text: "2*2*Alice Brown*00*00*12345*12345"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Alice Brown*00*00*12345*12345");
  ...
  it("Turn 9: Input: \"1\"", async () => {
    ...
    // Cumulative USSD text: "2*2*Alice Brown*00*00*12345*12345*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Alice Brown*00*00*12345*12345*1");
  ...
  it("Turn 10: Input: \"1\"", async () => {
    ...
    // Cumulative USSD text: "2*2*Alice Brown*00*00*12345*12345*1*1"
    // Send user input (USSD requires cumulative text)
    const response = await sendUssdRequest("2*2*Alice Brown*00*00*12345*12345*1*1");
