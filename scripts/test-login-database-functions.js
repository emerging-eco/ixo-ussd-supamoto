...
async function testLoginDatabaseFunctions() {
    ...
    try {
        ...
        if (existingCustomer) {
            ...
            const customer = await dataService.getCustomerByCustomerId(existingCustomer.customer_id);
            if (customer) {
        ...
        const nonExistentCustomer = await dataService.getCustomerByCustomerId("C99999999");
        ...
        if (existingCustomer && existingCustomer.encrypted_pin) {
            ...
            console.log(`🔒 Customer ${existingCustomer.customer_id} has PIN, testing clear...`);
            // Clear the PIN
            ...
            const customerAfterClear = await dataService.getCustomerByCustomerId(existingCustomer.customer_id);
...
//# sourceMappingURL=test-login-database-functions.js.map